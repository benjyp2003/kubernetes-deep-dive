...
const VisualizationControls = ({
  ...
  <div className="flex items-center gap-3 bg-card/80 backdrop-blur-sm border border-border rounded-xl px-4 py-3">
    ...
    <div className="flex items-center gap-2">
      ...
      <Slider
        ...
        className="w-20"
      />
      <span className="text-xs text-muted-foreground font-mono w-8">{speed}x</span>
    </div>
  </div>
);
